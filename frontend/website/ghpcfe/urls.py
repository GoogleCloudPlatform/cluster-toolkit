...
urlpatterns = [
    ...
    path('document/', TemplateView.as_view(template_name='document.html'), name='document'),
    ...
    path('credential/<int:pk>', CredentialDetailView.as_view(), name='credential-detail'),
    ...
    path('benchmark/<int:pk>', BenchmarkDetailView.as_view(), name='benchmark-detail'),
    path('account/', AccountUpdateView.as_view(), name='account'),
    path('workbench/', WorkbenchListView.as_view(), name='workbench'),
    path('workbench/<int:pk>', WorkbenchDetailView.as_view(), name='workbench-detail'),
]

urlpatterns += [
    path('credential/create/', CredentialCreateView.as_view(), name='credential-create'),
    path('vpc/create/', VPCCreateView1.as_view(), name='vpc-create'),
    path('vpc/create2/?credential=<int:credential>', VPCCreateView2.as_view(), name='vpc-create2'),
    ...
    path('job/create2/<int:app>/<int:cluster>', JobCreateView2.as_view(), name='job-create-2'),
    ...
    path('credential/update/<int:pk>', CredentialUpdateView.as_view(), name='credential-update'),
    path('vpc/update/<int:pk>', VPCUpdateView.as_view(), name='vpc-update'),
    path('cluster/update/<int:pk>', ClusterUpdateView.as_view(), name='cluster-update'),
    path('application/update/<int:pk>', ApplicationUpdateView.as_view(), name='application-update'),
    path('job/update/<int:pk>', JobUpdateView.as_view(), name='job-update'),
    path('credential/delete/<int:pk>', CredentialDeleteView.as_view(), name='credential-delete'),
    path('vpc/delete/<int:pk>', VPCDeleteView.as_view(), name='vpc-delete'),
    path('cluster/delete/<int:pk>', ClusterDeleteView.as_view(), name='cluster-delete'),
    path('application/delete/<int:pk>', ApplicationDeleteView.as_view(), name='application-delete'),
...
urlpatterns += [
    path('application/<int:pk>/logs/', ApplicationLogView.as_view(), name='application-log'),
    path('application/<int:pk>/logs/<int:logid>', ApplicationLogFileView.as_view(), name='application-log-file'),
    path('job/<int:pk>/logs/', JobLogView.as_view(), name='job-log'),
    path('job/<int:pk>/logs/<int:logid>', JobLogFileView.as_view(), name='job-log-file'),
    path('cluster/<int:pk>/logs/', ClusterLogView.as_view(), name='cluster-log'),
    path('cluster/<int:pk>/logs/<int:logid>', ClusterLogFileView.as_view(), name='cluster-log-file'),
]

urlpatterns += [
    path('vpc/destroy/<int:pk>', VPCDestroyView.as_view(), name='vpc-destroy'),
    path('cluster/destroy/<int:pk>', ClusterDestroyView.as_view(), name='cluster-destroy'),
    path('workbench/destroy/<int:pk>', WorkbenchDestroyView.as_view(), name='workbench-destroy'),
    path('cluster/cost/<int:pk>', ClusterCostView.as_view(), name='cluster-cost'),
]

urlpatterns += [
    re_path(r'^vpc/(?P<vpc_id>\d+)/subnets/$', \
        VirtualSubnetView.as_view(), name='vpc-subnets'),
]

urlpatterns += [
    path('filesystem/', FilesystemListView.as_view(), name='filesystems'),
    path('filesystem/create/', FilesystemCreateView1.as_view(), name='fs-create'),
    path('filesystem/create2/?credential=<int:credential>', FilesystemCreateView2.as_view(), name='fs-create2'),
    path('filesystem/detail/<int:pk>', FilesystemRedirectView.as_view(target='detail'), name = 'fs-detail'),
    ...
    path('backend/filesystem/destroy/<int:pk>', BackendDestroyFilesystem.as_view(), name='backend-filesystem-destroy'),

    path('filesystem/filestore/create/?credential=<int:credential>', GCPFilestoreFilesystemCreateView.as_view(), name='filestore-create'),
    path('filesystem/filestore/detail/<int:pk>', GCPFilestoreFilesystemDetailView.as_view(), name='filestore-detail'),
...
router.register(r'api/applications', ApplicationViewSet, basename='api-application')
router.register(r'api/clusters', ClusterViewSet, basename='api-cluster')
router.register(r'api/credentials', CredentialViewSet, basename='api-credential')
...
urlpatterns += [
    ...
    path('backend/vpc-destroy/<int:pk>', BackendDestroyVPC.as_view(), \
        name='backend-destroy-vpc'),
    path('backend/cluster-create/<int:pk>', BackendCreateCluster.as_view(), \
        name='backend-create-cluster'),
    path('backend/cluster-updateTF/<int:pk>', BackendUpdateClusterTerraform.as_view(), \
        name='backend-update-cluster'),
    path('backend/cluster-start/<int:pk>', BackendStartCluster.as_view(), \
        name='backend-start-cluster'),
    path('backend/cluster_destroy/<int:pk>', BackendDestroyCluster.as_view(), \
        name='backend-destroy-cluster'),
    path('backend/cluster-sync/<int:pk>', BackendSyncCluster.as_view(), \
    ...
    path('clusters/gcp-auth/<int:pk>', AuthUserGCP.as_view(), \
        name='user-gcp-auth'),

...
class Command(BaseCommand):
    help = 'Seeds default presets into the workbench preset model so normal users an create workbenches of an approved machine type'
    ...
    def handle(self, *args, **options):
        ...
        wbpreset1.save()
        self.stdout.write(str(wbpreset1) + ", Machine Type: " + wbpreset1.machine_type + ", Category: " + wbpreset1.category, ending='\n')
        ...
        wbpreset2.save()
        self.stdout.write(str(wbpreset2) + ", Machine Type: " + wbpreset2.machine_type + ", Category: " + wbpreset2.category, ending='\n')
        ...
        wbpreset3.save()
        self.stdout.write(str(wbpreset3) + ", Machine Type: " + wbpreset3.machine_type + ", Category: " + wbpreset3.category, ending='\n')
        ...
        wbpreset4.save()
        self.stdout.write(str(wbpreset4) + ", Machine Type: " + wbpreset4.machine_type + ", Category: " + wbpreset4.category, ending='\n')

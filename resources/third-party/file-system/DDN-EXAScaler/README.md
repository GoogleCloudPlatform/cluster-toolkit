...
**Please note**: This resource's instances require access to Google APIs and therefore, instances must have public IP address or it must be used in a subnetwork where [Private Google Access](https://cloud.google.com/vpc/docs/configure-private-google-access) is enabled. Currently, it can only be used with pre-existing-networks.

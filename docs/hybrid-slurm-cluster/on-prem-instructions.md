...
[slurmgcppacker]: https://github.com/GoogleCloudPlatform/slurm-gcp/tree/v5-test-wo-gethostbyname-fix/packer
[example.pkrvars.hcl]: https://github.com/GoogleCloudPlatform/slurm-gcp/tree/v5-test-wo-gethostbyname-fix/packer/example.pkrvars.hcl
[slurmversion]: https://github.com/GoogleCloudPlatform/slurm-gcp/blob/v5-test-wo-gethostbyname-fix/packer/variables.pkr.hcl#L97
[`service_account_scopes`]: https://github.com/GoogleCloudPlatform/slurm-gcp/blob/v5-test-wo-gethostbyname-fix/packer/variables.pkr.hcl#L166
[`munge_user`]: https://github.com/GoogleCloudPlatform/slurm-gcp/blob/v5-test-wo-gethostbyname-fix/ansible/roles/munge/defaults/main.yml#L17
[`slurm_user`]: https://github.com/GoogleCloudPlatform/slurm-gcp/blob/v5-test-wo-gethostbyname-fix/ansible/roles/slurm/defaults/main.yml#L31

...
[slurm-gcp]: https://github.com/SchedMD/slurm-gcp/tree/5.7.5
...
[hybrid.md]: https://github.com/SchedMD/slurm-gcp/blob/5.7.5/docs/hybrid.md
...
[slurmgcppacker]: https://github.com/SchedMD/slurm-gcp/tree/5.7.5/packer
[example.pkrvars.hcl]: https://github.com/SchedMD/slurm-gcp/tree/5.7.5/packer/example.pkrvars.hcl
[slurmversion]: https://github.com/SchedMD/slurm-gcp/blob/5.7.5/packer/variables.pkr.hcl#L97
[`service_account_scopes`]: https://github.com/SchedMD/slurm-gcp/blob/5.7.5/packer/variables.pkr.hcl#L166
[`munge_user`]: https://github.com/SchedMD/slurm-gcp/blob/5.7.5/ansible/roles/munge/defaults/main.yml#L17
[`slurm_user`]: https://github.com/SchedMD/slurm-gcp/blob/5.7.5/ansible/roles/slurm/defaults/main.yml#L31

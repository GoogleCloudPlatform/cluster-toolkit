...
* **[schedmd-slurm-gcp-v6-controller]** ![community-badge] :
  Creates a Slurm controller node using [slurm-gcp-version-6].
* **[schedmd-slurm-gcp-v6-login]** ![community-badge] :

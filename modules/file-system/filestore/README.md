...
| <a name="input_nfs_export_options"></a> [nfs\_export\_options](#input\_nfs\_export\_options) | Define NFS export options. | <pre>object({<br>    access_mode = optional(string)<br>    ip_ranges   = optional(list(string))<br>    squash_mode = optional(string)<br>  })</pre> | `null` | no |

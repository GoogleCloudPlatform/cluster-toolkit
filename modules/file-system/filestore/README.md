...
| <a name="input_network"></a> [network](#input\_network) | The GCE VPC network to which the instance is connected | <pre>object({<br>    id      = string<br>    name    = string<br>    project = string<br>  })</pre> | n/a | yes |

...
| Name | Type |
| ---- | ---- |
| [terraform_data.validate_confidential_storage](https://registry.terraform.io/providers/hashicorp/terraform/latest/docs/resources/data) | resource |
...
| <a name="input_disk_storage_pool"></a> [disk\_storage\_pool](#input\_disk\_storage\_pool) | Storage pool to use for the provisioned disks. Note that storage pools are only supported with Hyperdisk types. | `string` | `null` | no |

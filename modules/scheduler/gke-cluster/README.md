...
| <a name="output_enable_ml_diagnostics"></a> [enable\_ml\_diagnostics](#output\_enable\_ml\_diagnostics) | Indicates whether native ML Diagnostics is enabled on the GKE cluster. |

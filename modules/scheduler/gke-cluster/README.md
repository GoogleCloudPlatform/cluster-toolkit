...
| <a name="input_autoprovisioning_cpu_max"></a> [autoprovisioning\_cpu\_max](#input\_autoprovisioning\_cpu\_max) | Maximum number of CPU cores that the cluster can scale up to via Node Auto-Provisioning. | `number` | `1000000` | no |
| <a name="input_autoprovisioning_memory_max"></a> [autoprovisioning\_memory\_max](#input\_autoprovisioning\_memory\_max) | Maximum amount of memory (in GB) that the cluster can scale up to via Node Auto-Provisioning. | `number` | `10000000` | no |

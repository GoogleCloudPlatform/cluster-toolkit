...
| <a name="input_enable_cloud_dns_provider"></a> [enable\_cloud\_dns\_provider](#input\_enable\_cloud\_dns\_provider) | Offload the cluster DNS provider to Cloud DNS | `bool` | `false` | no |

...
| <a name="input_create_systemd_service"></a> [create\_systemd\_service](#input\_create\_systemd\_service) | Creates a new systemd service. Enable by setting name field. | <pre>object({<br/>    name              = optional(string, "")<br/>    user              = optional(string, "root")<br/>    type              = optional(string, "simple")<br/>    exec_start        = optional(string, "")<br/>    start_after       = optional(string, "network.target")<br/>    working_directory = optional(string, "/tmp")<br/>  })</pre> | <pre>{<br/>  "exec_start": "",<br/>  "name": "",<br/>  "start_after": "network.target",<br/>  "type": "simple",<br/>  "user": "root",<br/>  "working_directory": "/tmp"<br/>}</pre> | no |

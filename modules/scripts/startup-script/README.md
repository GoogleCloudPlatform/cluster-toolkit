...
| <a name="input_enable_cloud_rdma"></a> [enable\_cloud\_rdma](#input\_enable\_cloud\_rdma) | If true, will install and enable Cloud RDMA drivers. Currently only supported on Rocky Linux 8. | `bool` | `false` | no |

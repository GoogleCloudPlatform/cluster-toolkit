...
| <a name="input_gib"></a> [gib](#input\_gib) | Install the NCCL gIB plugin | <pre>object({<br/>    install = optional(bool, false)<br/>    version = optional(string, "v1.0.5")<br/>    accelerator_selector = optional(<br/>      list(string),<br/>      [<br/>        "nvidia-h200-141gb",<br/>        "nvidia-b200"<br/>      ]<br/>    )<br/>    accelerator_count = optional(number, 8)<br/>  })</pre> | `{}` | no |

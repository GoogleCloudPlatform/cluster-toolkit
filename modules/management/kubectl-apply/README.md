...
|------|-------------|------|---------|:--------:|
| <a name="input_apply_manifests"></a> [apply\_manifests](#input\_apply\_manifests) | An identifier for the gke cluster resource with format projects/<project\_id>/locations/<region>/clusters/<name>. | <pre>list(object({<br>    content           = optional(string, null)<br>    source            = optional(string, null)<br>    template_vars     = optional(any, null)<br>    server_side_apply = optional(bool, false)<br>  }))</pre> | `[]` | no |

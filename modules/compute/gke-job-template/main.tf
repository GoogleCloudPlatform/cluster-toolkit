...
locals {
  ...
  dranet_template_name_distinct = distinct(var.dranet_template_name)
  ...
  default_resource_claims = anytrue(var.enable_dranet) ? [{ name = "rdma", resource_claim_template_name = local.dranet_template_name_actual }] : []

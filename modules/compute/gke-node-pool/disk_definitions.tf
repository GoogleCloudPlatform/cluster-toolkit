...
locals {
  ...
  local_ssd_machines = {
    ...
    "a4-highgpu-8g-lowmem" = { local_ssd_count_ephemeral_storage = 32, local_ssd_count_nvme_block = null },
    "a4-highgpu-8g"        = { local_ssd_count_ephemeral_storage = 32, local_ssd_count_nvme_block = null },
  }

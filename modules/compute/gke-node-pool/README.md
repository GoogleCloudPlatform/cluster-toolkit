...
| <a name="output_allocatable_gpu_per_node"></a> [allocatable\_gpu\_per\_node](#output\_allocatable\_gpu\_per\_node) | Min number of GPUs available for scheduling pods among all nodes in a pool. |

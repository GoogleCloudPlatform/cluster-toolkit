...
| <a name="input_gke_version"></a> [gke\_version](#input\_gke\_version) | GKE version at creation time. Ignored on existing node pools to prevent unexpected rolling updates. | `string` | n/a | yes |

...
| <a name="input_enable_fast_socket"></a> [enable\_fast\_socket](#input\_enable\_fast\_socket) | Enable NCCL Fast Socket plugin on the nodes. Only compatible with GKE 1.25.2-gke.1700+ and images containing the Fast Socket plugin (or requires a daemonset). | `bool` | `false` | no |

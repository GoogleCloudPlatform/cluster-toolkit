...
| <a name="input_reservation_block"></a> [reservation\_block](#input\_reservation\_block) | The name of the reservation block. | `string` | `null` | no |
| <a name="input_reservation_sub_block"></a> [reservation\_sub\_block](#input\_reservation\_sub\_block) | The name of the reservation sub-block. | `string` | `null` | no |
| <a name="input_reservation_zone"></a> [reservation\_zone](#input\_reservation\_zone) | The specific zone where the reservation and sub-block are located. If not provided, falls back to iterating over all var.zones. | `string` | `null` | no |

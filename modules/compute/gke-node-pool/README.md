...
| <a name="input_enable_dranet"></a> [enable\_dranet](#input\_enable\_dranet) | Enable GKE managed Dynamic Resource Allocation (DRA) driver for networking (DRANET) and Accelerator Network Profile (ANP). If null, automatically enabled for GPU/TPU nodes on GKE 1.34.1-gke.1829001 or later. | `bool` | `null` | no |

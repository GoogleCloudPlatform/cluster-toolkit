...
| <a name="input_instance_image"></a> [instance\_image](#input\_instance\_image) | Instance Image | <pre>object({<br>    project = string,<br>    family  = optional(string),<br>    name    = optional(string)<br>  })</pre> | <pre>{<br>  "family": "hpc-centos-7",<br>  "name": null,<br>  "project": "cloud-hpc-image-public"<br>}</pre> | no |

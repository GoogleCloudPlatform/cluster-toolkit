...
|------|-------------|------|---------|:--------:|
| <a name="input_accelerator_configs"></a> [accelerator\_configs](#input\_accelerator\_configs) | JSON text containing the definition of GKE machine types and counts | `string` | `"{}"` | no |

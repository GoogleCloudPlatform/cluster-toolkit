...
| <a name="input_network_self_link"></a> [network\_self\_link](#input\_network\_self\_link) | The self link of the network to attach the VM. Set to `default` to use the default network. | `string` | n/a | yes |

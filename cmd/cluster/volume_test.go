...
func TestVolumeCmd_Success(t *testing.T) {
	...
	output, err := executeCommand(ClusterCmd, "volume", "--cluster", "test-cluster", "--cluster-region", "us-central1-a", "--project", "test-project")

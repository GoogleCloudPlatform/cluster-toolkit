...
This feature automatically configures the GKE cluster with the necessary settings, labels the user namespace, and configures the Workload Identity service accounts required by the ML Diagnostics SDK.
    ...
    ```yaml
      - id: gke-ml-diagnostics
        ...
        # settings:
          ...
          # If not provided, the value will be taken from gke-tpu-7x-cluster module
          # namespace: $(vars.user_namespace)
    ```

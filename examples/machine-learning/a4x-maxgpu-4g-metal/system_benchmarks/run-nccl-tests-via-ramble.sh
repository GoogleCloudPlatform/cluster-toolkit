...
ramble:
  ...
  variables:
    ...
    container_name: nccl-plugin-gib-diagnostic-arm64:v1.1.3
    container_uri: docker://us-docker.pkg.dev#gce-ai-infra/gpudirect-gib/nccl-plugin-gib-diagnostic-arm64:v1.1.3

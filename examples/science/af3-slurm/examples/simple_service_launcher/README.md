...
```bash
gcloud storage cp your-folding.json gs://${UNIQUE_JOB_BUCKET}/data_pipeline_toprocess/
```
...
```bash
gcloud storage cp your-folding.json gs://${UNIQUE_JOB_BUCKET}/inference_toprocess/
```

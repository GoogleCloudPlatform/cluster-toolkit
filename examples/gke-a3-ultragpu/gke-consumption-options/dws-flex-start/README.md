...
1. In the `examples/gke-a3-ultragpu/gke-consumption-options/dws-flex-start/gke-a3-ultragpu-deployment.yaml` file, fill in the following settings in the terraform_backend_defaults and vars sections to match the specific values for your deployment:
    ...
    **`enable_flex_start`**: enable DWS Flex Start.\
    ...
    To modify advanced settings, edit `examples/gke-a3-ultragpu/gke-consumption-options/dws-flex-start/gke-a3-ultragpu.yaml`.
...
1. Deploy the blueprint to provision the GKE infrastructure using A3 Ultra machine types:
    ...
    cd ~/cluster-toolkit
    ./gcluster deploy -d \
    examples/gke-a3-ultragpu/gke-consumption-options/dws-flex-start/gke-a3-ultragpu-deployment.yaml \
    examples/gke-a3-ultragpu/gke-consumption-options/dws-flex-start/gke-a3-ultragpu.yaml
    ```
...
1. Run the jobs.
    ...
    ```sh
    kubectl apply -f examples/gke-a3-ultragpu/gke-consumption-options/dws-flex-start/dws-flex-start.yaml
    ```

...
func deprecatedSchema070a() {
	...
	os.Stderr.WriteString("  'resource_groups'       become 'deployment_groups'\n")
	os.Stderr.WriteString("  'resources'             become 'modules'\n")
	os.Stderr.WriteString("  'source: resources/...' become 'source: modules/...'\n")

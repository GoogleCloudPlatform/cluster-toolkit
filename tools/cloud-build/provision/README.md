...
| <a name="input_kueue_migrated_tests"></a> [kueue\_migrated\_tests](#input\_kueue\_migrated\_tests) | List of tests migrated to Kueue | `list(string)` | <pre>[<br/>  "slurm-gcp-v6-rocky8",<br/>  "batch-mpi",<br/>  "htcondor",<br/>  "packer",<br/>  "monitoring",<br/>  "chrome-remote-desktop",<br/>  "chrome-remote-desktop-ubuntu",<br/>  "ansible-vm",<br/>  "e2e",<br/>  "hcls"<br/>]</pre> | no |

...
EXCLUDE_EXAMPLE["community/examples/slurm-hybrid-cloud-burst/primary-cluster.yaml"]=
EXCLUDE_EXAMPLE["community/examples/slurm-hybrid-cloud-burst/burst-cluster.yaml"]=

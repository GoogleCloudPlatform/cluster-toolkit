...
run_test() {
	...
	VALIDATORS_TO_SKIP="test_project_exists,test_apis_enabled,test_region_exists,test_zone_exists,test_zone_in_region,test_quota_availability,test_machine_type_in_zone"
	GHPC_PATH="${cwd}/ghpc"
	BP_PATH="${cwd}/${example}"

...
| <a name="module_remote-desktop-linux"></a> [remote-desktop-linux](#module\_remote-desktop-linux) | github.com/GoogleCloudPlatform/hpc-toolkit/community/modules/remote-desktop-linux | ### |
...
| <a name="input_configure_chrome_remote_desktop"></a> [configure\_chrome\_remote\_desktop](#input\_chrome\_remote\_desktop) | This will trigger the installation of chrome remote desktop. Does not install and run Chrome remote desktop if set to false. | `bool` | `true` | no |

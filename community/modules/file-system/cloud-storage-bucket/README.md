...
| <a name="input_uniform_bucket_level_access"></a> [uniform\_bucket\_level\_access](#input\_uniform\_bucket\_level\_access) | If true, allow uniform control access to the bucket. | `bool` | `false` | no |

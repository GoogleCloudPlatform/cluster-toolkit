...
```yaml
  ...
  - id: mount-at-startup
    ...
    settings:
      runners:
      - $(lustrefs.network_storage.client_install_runner)
      - $(lustrefs.network_storage.mount_runner)
...
| <a name="input_image"></a> [image](#input\_image) | Source image properties | `any` | <pre>{<br>  "family": "exascaler-cloud-6-2-rocky-linux-8-optimized-gcp",<br>  "project": "ddn-public"<br>}</pre> | no |

...
| <a name="input_cls"></a> [cls](#input\_cls) | Compute client properties | <pre>object({<br/>    node_type  = optional(string, "n2-standard-2")<br/>    node_cpu   = optional(string, "Intel Cascade Lake")<br/>    nic_type   = optional(string, "GVNIC")<br/>    node_count = optional(number, 0)<br/>    public_ip  = optional(bool, false)<br/>  })</pre> | `{}` | no |
...
| <a name="input_mds"></a> [mds](#input\_mds) | Metadata server properties | <pre>object({<br/>    node_type  = optional(string, "n2-standard-32")<br/>    node_cpu   = optional(string, "Intel Cascade Lake")<br/>    nic_type   = optional(string, "GVNIC")<br/>    node_count = optional(number, 1)<br/>    public_ip  = optional(bool, false)<br/>  })</pre> | `{}` | no |
...
| <a name="input_mgs"></a> [mgs](#input\_mgs) | Management server properties | <pre>object({<br/>    node_type  = optional(string, "n2-standard-32")<br/>    node_cpu   = optional(string, "Intel Cascade Lake")<br/>    nic_type   = optional(string, "GVNIC")<br/>    node_count = optional(number, 1)<br/>    public_ip  = optional(bool, false)<br/>  })</pre> | `{}` | no |
...
| <a name="input_oss"></a> [oss](#input\_oss) | Object Storage server properties | <pre>object({<br/>    node_type  = optional(string, "n2-standard-16")<br/>    node_cpu   = optional(string, "Intel Cascade Lake")<br/>    nic_type   = optional(string, "GVNIC")<br/>    node_count = optional(number, 3)<br/>    public_ip  = optional(bool, false)<br/>  })</pre> | `{}` | no |

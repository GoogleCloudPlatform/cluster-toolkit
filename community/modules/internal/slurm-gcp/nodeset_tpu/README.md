...
| <a name="input_docker_image"></a> [docker\_image](#input\_docker\_image) | The gcp container registry id docker image to use in the TPU vms, it defaults to gcr.io/schedmd-public-292016/tpu:slurm-gcp-6-8-tf-<var.tf\_version> | `string` | `""` | no |

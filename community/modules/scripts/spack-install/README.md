...
| <a name="output_spack_setup_runner"></a> [spack\_setup\_runner](#output\_spack\_setup\_runner) | Adds Spack setup-env.sh script to /etc/profile.d so that it is called at shell startup. Among other things this adds Spack binary to user PATH. |

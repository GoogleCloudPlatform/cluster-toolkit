...
| <a name="output_install_spack_runner"></a> [install\_spack\_runner](#output\_install\_spack\_runner) | Runner that incorporates the contents of the following other runners, executed<br>in this order: spack\_install\_runner, spack\_commands\_runner,<br>spack\_compiler\_runner, spack\_packages\_runner.<br><br>Usage:<br>- id: example-startup-script<br>  source: modules/scripts/startup-script<br>  settings:<br>    runners:<br>    - $(your-spack-id.install\_spack\_runner)<br>... |

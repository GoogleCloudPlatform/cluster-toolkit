...
output "registry_url" {
  description = "The URL of the artifact registry repo. (Deprecated: Use 'repo_url' instead)"
  # Technically, this is the repo URL, not the registry URL; preserved for backward compatibility
  value = local.repo_url
}

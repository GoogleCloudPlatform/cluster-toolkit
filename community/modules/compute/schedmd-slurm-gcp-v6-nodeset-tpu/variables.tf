...
variable "docker_image" {
  description = "The gcp container registry id docker image to use in the TPU vms, it defaults to gcr.io/schedmd-public-292016/tpu:slurm-gcp-6-9-tf-<var.tf_version>"
  type        = string
  default     = null
}

...
| <a name="input_startup_script"></a> [startup\_script](#input\_startup\_script) | Startup script used by VMs in this nodeset.<br>NOTE: will be executed after `compute_startup_script` defined on controller module. | `string` | `""` | no |

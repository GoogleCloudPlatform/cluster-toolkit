...
| <a name="input_provisioning_engine"></a> [provisioning\_engine](#input\_provisioning\_engine) | Compute node provisioning engine: 'AUTO', 'MIG', or 'BULK\_INSERT'. | `string` | `"AUTO"` | no |

...
| <a name="input_network"></a> [network](#input\_network) | The GCE VPC network to host the cluster. | <pre>object({<br>    id = string,<br>    primary_subnet = object({<br>      self_link = string<br>    })<br>  })</pre> | n/a | yes |

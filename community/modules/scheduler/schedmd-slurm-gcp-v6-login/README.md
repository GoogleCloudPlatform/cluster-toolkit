...
[slurm\_login\_instance]: https://github.com/SchedMD/slurm-gcp/tree/6.1.2/terraform/slurm_cluster/modules/slurm_login_instance
...
[slurm-on-gcp]: https://github.com/SchedMD/slurm-gcp/tree/6.1.2
[slurm-gcp-readme]: https://github.com/SchedMD/slurm-gcp/tree/6.1.2#slurm-on-google-cloud-platform
...
| <a name="input_group_name"></a> [group\_name](#input\_group\_name) | Name of the login nodes group. | `string` | n/a | yes |

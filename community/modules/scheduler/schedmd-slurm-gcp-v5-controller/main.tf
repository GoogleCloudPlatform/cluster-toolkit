...
module "slurm_controller_instance" {
  source = "github.com/GoogleCloudPlatform/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_controller_instance?ref=v5-test-wo-gethostbyname-fix"
...
module "slurm_controller_template" {
  source = "github.com/GoogleCloudPlatform/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_instance_template?ref=v5-test-wo-gethostbyname-fix"

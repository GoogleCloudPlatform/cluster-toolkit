...
- Has the same mounted file systems as the first provided `cloud-batch-job`.
...
| <a name="input_job_filename"></a> [job\_filename](#input\_job\_filename) | Deprecated: The filename of the generated job template file. Typically supplied by a cloud-batch-job module. | `string` | `null` | no |
| <a name="input_job_id"></a> [job\_id](#input\_job\_id) | Deprecated: The ID for the Google Cloud Batch job. Typically supplied by a cloud-batch-job module for use in the output instructions. | `string` | `null` | no |
| <a name="input_job_template_contents"></a> [job\_template\_contents](#input\_job\_template\_contents) | Deprecated: The contents of the Google Cloud Batch job template. Typically supplied by a cloud-batch-job module. | `string` | `null` | no |

...
[slurm\_login\_instance]: https://github.com/SchedMD/slurm-gcp/tree/v5.5.0/terraform/slurm_cluster/modules/slurm_login_instance
...
[slurm-on-gcp]: https://github.com/SchedMD/slurm-gcp/tree/v5.5.0
[slurm-gcp-readme]: https://github.com/SchedMD/slurm-gcp/tree/v5.5.0#slurm-on-google-cloud-platform
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_slurm_login_instance"></a> [slurm\_login\_instance](#module\_slurm\_login\_instance) | github.com/SchedMD/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_login_instance | 5.5.0 |
| <a name="module_slurm_login_template"></a> [slurm\_login\_template](#module\_slurm\_login\_template) | github.com/SchedMD/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_instance_template | 5.5.0 |

...
[slurm\_login\_instance]: https://github.com/GoogleCloudPlatform/slurm-gcp/tree/v5-test-wo-gethostbyname-fix/terraform/slurm_cluster/modules/slurm_login_instance
...
[slurm-on-gcp]: https://github.com/GoogleCloudPlatform/slurm-gcp/tree/v5-test-wo-gethostbyname-fix
[slurm-gcp-readme]: https://github.com/GoogleCloudPlatform/slurm-gcp/tree/v5-test-wo-gethostbyname-fix#slurm-on-google-cloud-platform
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_slurm_login_instance"></a> [slurm\_login\_instance](#module\_slurm\_login\_instance) | github.com/GoogleCloudPlatform/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_login_instance | v5-test-wo-gethostbyname-fix |
| <a name="module_slurm_login_template"></a> [slurm\_login\_template](#module\_slurm\_login\_template) | github.com/GoogleCloudPlatform/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_instance_template | v5-test-wo-gethostbyname-fix |

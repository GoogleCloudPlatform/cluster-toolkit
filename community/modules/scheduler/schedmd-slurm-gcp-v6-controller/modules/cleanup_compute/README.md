...
| <a name="input_nodeset"></a> [nodeset](#input\_nodeset) | Nodeset to cleanup | <pre>object({<br/>    nodeset_name         = string<br/>    subnetwork_self_link = string<br/>    additional_networks = optional(list(object({<br/>      subnetwork         = optional(string)<br/>      network_attachment = optional(string)<br/>    })), [])<br/>  })</pre> | n/a | yes |

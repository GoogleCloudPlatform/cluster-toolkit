...
| <a name="input_controller_home"></a> [controller\_home](#input\_controller\_home) | GCS bucket path to mount controller home directory across the cluster. | `string` | `null` | no |

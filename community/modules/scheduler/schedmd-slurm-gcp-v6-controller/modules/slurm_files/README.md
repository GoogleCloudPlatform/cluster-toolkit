...
| <a name="input_experimental"></a> [experimental](#input\_experimental) | Experimental Slurm settings. | <pre>object({<br/>    enable_async_reply = optional(bool, false)<br/>  })</pre> | `{}` | no |

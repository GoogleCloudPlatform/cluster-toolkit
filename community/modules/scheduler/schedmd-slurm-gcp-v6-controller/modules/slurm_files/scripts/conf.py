...
def conflines(lkp: util.Lookup) -> str:
    ...
    conf_options = {
        **(comma_params if not no_comma_params else {}),
        ...
        "TaskProlog": f"{task_prolog_path}/main_task_prolog" if lkp.cfg.task_prolog_scripts else None,
        "TaskEpilog": f"{task_epilog_path}/main_task_epilog" if lkp.cfg.task_epilog_scripts else None,

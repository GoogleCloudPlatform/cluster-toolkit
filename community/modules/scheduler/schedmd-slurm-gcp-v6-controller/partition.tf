...
module "slurm_nodeset_template" {
  source   = "github.com/GoogleCloudPlatform/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_instance_template?ref=7dddbc9a7721b9e83360fd8cba866faf9485be46"
...
module "slurm_nodeset_tpu" {
  source   = "github.com/GoogleCloudPlatform/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_nodeset_tpu?ref=7dddbc9a7721b9e83360fd8cba866faf9485be46"

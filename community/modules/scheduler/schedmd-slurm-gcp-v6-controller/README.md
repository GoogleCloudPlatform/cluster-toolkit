...
| [google_kms_crypto_key_iam_member.decrypter](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/kms_crypto_key_iam_member) | resource |
| [google_kms_crypto_key_iam_member.encrypter](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/kms_crypto_key_iam_member) | resource |
...
| [google_kms_secret_ciphertext.jwt_key](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/kms_secret_ciphertext) | resource |
| [google_kms_secret_ciphertext.munge_key](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/kms_secret_ciphertext) | resource |
| [google_kms_secret_ciphertext.sql_password](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/kms_secret_ciphertext) | resource |
...
| <a name="input_jwt_key"></a> [jwt\_key](#input\_jwt\_key) | Specific libjwt key to use | `string` | `null` | no |
| <a name="input_kms"></a> [kms](#input\_kms) | KMS configuration. If location is not specified, var.region will be used. | <pre>object({<br/>    location = optional(string)<br/>    rotation = optional(string, "2592000s")<br/>  })</pre> | `{}` | no |
| <a name="input_kms_key"></a> [kms\_key](#input\_kms\_key) | Key to use to encrypt/decrypt secrets | `string` | `null` | no |
...
| <a name="input_munge_key"></a> [munge\_key](#input\_munge\_key) | Specific munge key to use | `string` | `null` | no |
...
| <a name="input_with_kms"></a> [with\_kms](#input\_with\_kms) | Enable or disable KMS resource creation | `bool` | `true` | no |

...
| <a name="input_provisioning_engine"></a> [provisioning\_engine](#input\_provisioning\_engine) | Compute node provisioning engine: 'MIG' or 'BULK\_INSERT' | `string` | `"BULK_INSERT"` | no |

...
| <a name="input_slurm_conf_tpl"></a> [slurm\_conf\_tpl](#input\_slurm\_conf\_tpl) | Slurm slurm.conf template. | <pre>object({<br/>    content = optional(string)<br/>    source  = optional(string)<br/>  })</pre> | `{}` | no |

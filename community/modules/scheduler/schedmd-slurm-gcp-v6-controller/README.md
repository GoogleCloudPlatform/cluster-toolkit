...
| <a name="input_health_check"></a> [health\_check](#input\_health\_check) | Health check and autohealing configuration for controller HA instance groups. | <pre>object({<br/>    type                 = optional(string, "tcp")<br/>    port                 = optional(number, 6818)<br/>    initial_delay_sec    = optional(number, 900)<br/>    check_interval_sec   = optional(number, 30)<br/>    timeout_sec          = optional(number, 10)<br/>    healthy_threshold    = optional(number, 2)<br/>    unhealthy_threshold  = optional(number, 3)<br/>    enable_logging       = optional(bool, true)<br/>    request_path         = optional(string, "/healthz")<br/>    create_firewall_rule = optional(bool, true)<br/>  })</pre> | `{}` | no |

...
# Going to want almost all the models here - makes a wildcard worth it
...
class ClusterAdmin(admin.ModelAdmin):
    ...
    def _controller_node(self, obj):
        if obj.controller_node:
            return (
                obj.controller_node.public_ip
                if obj.controller_node.public_ip
                else obj.controller_node.internal_ip
            )
        else:
            return "<none>"
...
admin.site.register(User, GHPCFEUserAdmin)
